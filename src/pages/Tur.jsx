...
const Tur = () => {
 ...
 <div className="maldiv">
                        ...
                        <b><button className="but-maldiv">Подробнее</button></b>
                    </div>
                </>) :  selected === "barselona" ? (<>
                    <div className="barc">
                        ...
                        <b><button className="but-barc">Подробнее</button></b>
                    </div>
                </>) : selected === "dubai" ? (<>
                    <div className="dubai">
                        ...
                        <b><button className="but-dubai">Подробнее</button></b>
                    </div>
                </>) :selected === "egyp" ? (<>
                    <div className="egyp">
                        ...
                        <b><button className="but-egyp">Подробнее</button></b>
                    </div>
                </>) : selected === "ind" ? (<>
                    <div className="ind">
                        ...
                        <b><button className="but-ind">Подробнее</button></b>
                    </div>
                </>) : selected === "paris" ? (<>
                    <div className="paris">
                        ...
                        <b><button className="but-paris">Подробнее</button></b>
                    </div>
                </>) : (<></>)
            }
                </div>
